...
import {
  ...
  MoreVert, DoneAll, Inventory, Add
...
const SellerNotifications = () => {
  ...
  return (
    <Box sx={{ position: 'relative', minHeight: '100vh', bgcolor: '#F5F5F4' }}>
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                <Box sx={{ 
                  ...
                  <Badge badgeContent={unreadCount} color="error">
                    <NotificationsActive sx={{ fontSize: 32, color: '#8B7355' }} />
                  </Badge>
                </Box>
                <Box>
                  ...
                  <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                    Stay updated with orders, products, and account status
                  </Typography>
                </Box>
              </Stack>
          ...
          >
            <Paper
              sx={{
                ...
                px: 4,
                borderRadius: 4,
                border: `1px solid ${alpha('#8B7355', 0.2)}`
              }}
            >
              <Notifications sx={{ fontSize: 80, color: alpha('#8B7355', 0.5), mb: 3 }} />
              ...
              <Typography variant="body1" sx={{ color: 'text.secondary', mb: 4 }}>
                {tabValue === 1 ? 'All caught up! You have no unread notifications.' :
                 ...
                 'We\'ll notify you about new orders, product approvals, and account updates.'}
              </Typography>
              <Button
                variant="contained"
                size="large"
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    boxShadow: `0 12px 35px ${alpha('#8B7355', 0.4)}`
                  },
                  ...
                  {filteredNotifications.map((notification, index) => (
                    ...
                    >
                      ...
                      {index < filteredNotifications.length - 1 && (
                        <Divider sx={{ borderColor: alpha('#8B7355', 0.1) }} />
                      )}
                    </motion.div>
                  ))}
                </AnimatePresence>
