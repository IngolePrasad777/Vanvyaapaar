...
import {
  ...
  MoreVert, DoneAll, AdminPanelSettings, People, Inventory
...
const AdminNotifications = () => {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <AdminPanelSettings sx={{ fontSize: 24 }} />
    }
  }
  ...
  return (
    <Box sx={{ position: 'relative', minHeight: '100vh', bgcolor: '#F9FAFB' }}>
              ...
              <Stack direction="row" alignItems="center" spacing={2}>
                <Box sx={{ 
                  ...
                  <Badge badgeContent={unreadCount} color="error">
                    <AdminPanelSettings sx={{ fontSize: 32, color: '#A0826D' }} />
                  </Badge>
                </Box>
                <Box>
                  ...
                  <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                    Platform alerts, user registrations, and system updates
                  </Typography>
                </Box>
              </Stack>
          ...
          >
            <Paper
              sx={{
                ...
                px: 4,
                borderRadius: 4,
                border: `1px solid ${alpha('#A0826D', 0.2)}`
              }}
            >
              <AdminPanelSettings sx={{ fontSize: 80, color: alpha('#A0826D', 0.5), mb: 3 }} />
              ...
              <Typography variant="body1" sx={{ color: 'text.secondary', mb: 4 }}>
                {tabValue === 1 ? 'All caught up! You have no unread notifications.' :
                 ...
                 'We\'ll notify you about new seller registrations, complaints, and system alerts.'}
              </Typography>
              <Button
                variant="contained"
                size="large"
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    boxShadow: `0 12px 35px ${alpha('#A0826D', 0.4)}`
                  },
                  ...
                  {filteredNotifications.map((notification, index) => (
                    ...
                    >
                      ...
                      {index < filteredNotifications.length - 1 && (
                        <Divider sx={{ borderColor: alpha('#A0826D', 0.1) }} />
                      )}
                    </motion.div>
                  ))}
                </AnimatePresence>
